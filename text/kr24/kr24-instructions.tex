...
% affiliations when submitting the paper for review. In place of names and
% affiliations, provide a list of content areas. When referring to one's own
% work, use the third person rather than the first person. For example, say,
% ``Previously, Gottlob~\shortcite{gottlob:nonmon} has shown that\ldots'',
% rather than, ``In our previous work~\cite{gottlob:nonmon}, we have shown
% that\ldots'' Try to avoid including any information in the body of the paper
...
% You cannot include author names in your submitted PDF metadata. Any paper
% breaking this rule may be desk rejected without review.
